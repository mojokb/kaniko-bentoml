...
setuptools.setup(
    name='PytorchModelService',
    version='20211125145848_83B2F2',
    description="BentoML generated model module",
    long_description="""# Generated BentoService bundle - PytorchModelService:20211125145848_83B2F2
...
""",
    ...
    package_data={
        'PytorchModelService': ['bentoml.yml', 'artifacts/*']
    },
    entry_points={
        'console_scripts': [
            'PytorchModelService=PytorchModelService:cli',
        ],
    }
)
